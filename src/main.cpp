...
uint256 hashGenesisBlock("0xff5c4ea54961d0e310b2f41f202b2d5ea7bc0abf94bca1ab7f90391731e51552");
...
const string strMessageMagic = "IndieCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // IndieCoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // IndieCoin: 2.5 minutes
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal indiecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "IndieCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("37cfbc16c2fb17585ba02b7cc5e00cea537b8037397686a80338fb144c0dd65e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "IndieCoins Coins for Indies";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1370321308; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 531922;

        if (fTestNet)
        {
            block.nTime    = 1370311123;
            block.nNonce   = 2301933;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xd50308031d20184895c65f1427786f88aec0d8be00cb0670c44616e39cdbaec3"));
